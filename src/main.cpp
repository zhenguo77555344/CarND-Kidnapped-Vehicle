...
int main()
{
  ...
  /************Begin Testing for Class of particle********************************
  std::cout<<"Hello I am in main function!"<<endl;
  ...
  //Load map data
  Map map;
  bool mapdataFlag=read_map_data("../data/map_data.txt",map);
  ...
  map.landmark_list.end();
  map.landmark_list.at(0).id_i;
  ...
  for(int i=0;i<map.landmark_list.size();i++){
      ...
      std::cout<<"id_i="<<map.landmark_list.at(i).id_i<<endl;
      if(!PF.initialized()){
          ...
          double previous_velocity = 5.0;
          double previous_yawrate = 0.001;

          PF.prediction(delta_t,sigma_pos,previous_velocity,previous_yawrate);

      }

      vector<LandmarkObs> noisy_observation;



      PF.updateWeights(sensor_range,noisy_observation,map.landmark_list,map);
  ...
  //std::cout<<"map data list"<<endl;
  //for(std::vector<sigma_landmark_s>::iterator iter = map.begin(); iter != map.end();iter++){
  //    std::cout<<"map data list"<<endl;

  //}


  //std::cout<<"map data list"<<endl<<map.landmark_list[0]<<endl;
  //std::cout<<"load map data"<<endl;

  ************End Testing for Class of particle*********************************/
